 ...
 */
export const ResponseResultType = proto3.makeEnum(
  "ibc.core.channel.v1.ResponseResultType",
  [
    {no: 0, name: "RESPONSE_RESULT_TYPE_UNSPECIFIED", localName: "UNSPECIFIED"},
    {no: 1, name: "RESPONSE_RESULT_TYPE_NOOP", localName: "NOOP"},
    {no: 2, name: "RESPONSE_RESULT_TYPE_SUCCESS", localName: "SUCCESS"},
  ],
);
