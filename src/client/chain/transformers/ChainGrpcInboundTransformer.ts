...
export class ChainGrpcInboundTransformer {
  ...
  private static incomingTxObject(incomingTx: IncomingTx): IncomingTx.AsObject {
    return {
      ...
      sourcetimestamp: incomingTx.getSourcetimestamp(),
      routerbridgecontract: incomingTx.getRouterbridgecontract(),
      payload: incomingTx.getPayload(),
      gaslimit: incomingTx.getGaslimit(),
      txfeeinroute: incomingTx.getTxfeeinroute()
        ? incomingTx.getTxfeeinroute()?.toObject()
        : undefined,
